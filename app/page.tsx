  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-purple-50 to-indigo-50">
      ...
      <header className="sticky top-0 z-40 border-b border-violet-200/50 bg-white/80 backdrop-blur-xl supports-[backdrop-filter]:bg-white/60">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold bg-gradient-to-r from-violet-600 to-purple-600 bg-clip-text text-transparent">Slotify</h1>
              <p className="text-xs text-muted-foreground hidden sm:block">Réservation de salle d&apos;étude</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <Button size="sm" asChild className="bg-gradient-to-r from-violet-500 to-purple-600 hover:from-violet-600 hover:to-purple-700 shadow-lg shadow-violet-500/30">
      ...
      <main className="py-6 sm:py-8">
        ...
        <Dialog open={!!cancellationCode} onOpenChange={(open) => !open && setCancellationCode(null)}>
          <DialogContent className="sm:max-w-[520px] border-2 border-emerald-200">
            <DialogHeader>
              ...
              <DialogDescription className="text-center text-slate-600">
                Conservez précieusement ce code pour annuler votre réservation si nécessaire
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="rounded-xl border-2 border-amber-200 bg-gradient-to-br from-amber-50 to-orange-50 p-4">
              <p className="text-sm text-amber-900 font-medium">
                <strong className="text-orange-600">⚠️ Important:</strong> L&apos;annulation est possible jusqu&apos;à 24h avant le début du créneau.
              </p>
            </div>
      ...
      <footer className="border-t border-violet-200/50 bg-white/60 backdrop-blur-xl mt-12">
        <div className="max-w-7xl mx-auto px-4 py-6 text-center">
          <p className="text-sm text-slate-600">
            <span className="font-semibold bg-gradient-to-r from-violet-600 to-purple-600 bg-clip-text text-transparent">Slotify</span> - Plateforme de réservation de salle d&apos;étude
          </p>
        </div>
      </footer>
    </div>
